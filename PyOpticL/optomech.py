...
class eval_miniTA:
    ...
    def execute(self, obj):
        ...
        part = part.fuse(_custom_cylinder(dia=2.1, dz=2*inch, x=9.12, y=15.75, z=-13.1+height))

        part = part.fuse(_custom_cylinder(dia=2.1, dz=2*inch, x=9.12, y=-15.75, z=-13.1+height))

        part = part.fuse(_custom_cylinder(dia=2.1, dz=2*inch, x=9.12-50, y=-15.75, z=-13.1+height))
